...
async function createLesson(
  ...
  /*
   * Go straight into the same
   * lesson editor you already use.
   */
  redirect(
...
export default async function AdminLearningPage({
  ...
  /*
   * Supabase nested relations
   * are not guaranteed to come
   * back sorted, so sort them
   * here as well.
   */
